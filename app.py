...
#crate the packet name
app = Flask(__name__)

key = os.urandom(24) #create random secret key
...
mysql = MySQL(app) #creates an instance which will provide us the access.
...
def register(): 
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form : 
        ...
        elif not re.match(r'[^@]+@[^@]+\.[^@]+', email):  #checking that the email valid
